...
const guideItems = [
  {
    ...
    description: 'Use the compass to explore different argument vectors and perspectives.',
  },
  {
    icon: <FaLayerGroup size={22} />,
    title: 'Layer Insights',
    description: 'Overlay moral, logical, and emotional layers to gain deeper understanding.',
  },
  {
    icon: <FaInfoCircle size={22} />,
    title: 'Interpret Signals',
    description: 'Read live signals from speakers and participants in real time.',
  },
  {
    icon: <FaQuestionCircle size={22} />,
    title: 'Seek Clarity',
    description: 'Use prompts and context maps to reframe or clarify emerging tensions.',
  },
];
